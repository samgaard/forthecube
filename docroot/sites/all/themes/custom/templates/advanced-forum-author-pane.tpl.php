...
<div class="author-pane">
 <div class="author-pane-inner">
    ...
    <div class="author-pane-section author-pane-general">
			<?php print (isset($account->field_first_name['und']) ? str_replace($account->name, $account->field_first_name['und'][0]['value'], $account_name) : str_replace("\"", "'", $account_name)); ?>
      <?php if (!empty($picture)): ?>
      <?php 			
				$profile_info  = '';
				$picture = (isset($account->picture->uri) ? theme('image_style', array('path' => $account->picture->uri, 'style_name' => 'profile')) : theme('image', array('path' => 'sites/default/files/profile_pics/default_user_icon.jpg')));
				$profile_info .= (isset($account->field_first_name['und'][0]) ? $account->field_first_name['und'][0]['value'] . '<br />' : '');
				$profile_info .= (isset($account->field_modo_name['und'][0]) ? 'MTGO: ' . $account->field_modo_name['und'][0]['value'] . '<br />' : '');
			?>
        <a class="user-picture" data-original-title="<?php print $profile_info; ?>" data-html="true" data-placement="right" href="#" data-toggle="tooltip" title=""><?php print $picture; ?></a>
      <?php endif; ?>
